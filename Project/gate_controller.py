# copied and adapted from exercise 08-Simple Routing
...
class RoutingController(object):
    ...
    def __init__(self):
        ...
        self.gates = ["ext", "int"]
        self.switches = self.gates + ["ge1", "ge2", "ge3", "fir"]
        self.topo = Topology(db="topology.db")
        self.controllers = {}
        self.init()

    def init(self):
        self.connect_to_gates()
        self.reset_states()
    ...
    def connect_to_gates(self):
        for p4switch in self.gates:
    ...
    def route(self):
        ...
        switch_ecmp_groups = {sw_name:{} for sw_name in self.switches}
